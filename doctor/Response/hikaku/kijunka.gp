...
set output "kijunka.eps"
set data style lines
set xrange [0:0.1]
set key bottom
set xlabel "story deformation angle (rad)"
set ylabel "normalized restoring force of 2nd story"
set label "{/Symbol b}=0.4, {/Symbol g}=1.2" at 0.07,1.6

plot '../figs/total.dat' title "²òÀÏ¥â¥Ç¥ë" lw 5, 'shichijo.out' u 2:1 title "SIÅ¡", 'tsuji.out' u 2:1 title "TUÅ¡", 'tanaka.out' u 2:1 title "TAÅ¡", 'sugiura.out' u 2:1 title "SUÅ¡", 'haumesse.out' u 2:1 title "HÅï"


set term corel color
set output "kijunka.cdr"
set data style lines
set xrange [0:0.1]
set key bottom
set xlabel "story deformation angle (rad)"
...
plot '../figs/total.dat' title "model" lw 5, 'shichijo.out' u 2:1 title "SI", 'tsuji.out' u 2:1 title "TU", 'tanaka.out' u 2:1 title "TA", 'sugiura.out' u 2:1 title "SU", 'haumesse.out' u 2:1 title "H"
