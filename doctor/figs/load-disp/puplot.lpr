# -*- Gnu-Plot -*-
# ‰×d`•ÏˆÊŠÖŒW‚¨‚æ‚Ñ‰×d`‚Ë‚¶‚ê•ÏŒ`ŠpŠÖŒW‚ğƒvƒƒbƒg‚·‚é‚½‚ß‚Ì 
# GNUPLOT ƒRƒ}ƒ“ƒh
...
#set label "\small{\sf    #70}\ ŠO•Ç•ö‚ê" at 21,9.5
#set label "\small{\sf    #77}\ •Ç—‰º" at 21,8.8
#set label "\small{\sf    #78}\ ’ŒŒXÎA•Ç‚Ì‚¿‚è" at 21,8.1
#set label "\small{\sf    #91}\ ƒNƒŒ[ƒ“‚·‚×‚è" at 21,7.4
#set label "\small{\sf    #149}\ áq”j‚ên‚ß" at 21,6.7
#set label "\small{\sf    #155}\ ‹Øˆá—‚¿‚é" at 21,6.0
...
#set label "\small{\sf    #109}\ ‰®ª‚ª˜c‚İn‚ß‚½" at 15,9.5
#set label "\small{\sf    #110}\ ‘‹‚Ì‰º‚Ì•Ç‚ÉƒNƒ‰ƒbƒN" at 15,8.8
#set label "\small{\sf    #189}\ •Ç‚ª•ö‚ê‚é" at 15,8.1
#set label "\small{\sf    # 199}\ “ì“Œ‚Ì‹÷’Œ‚ªÜ‚ê‚é" at 15,7.4
#set label "\small{\sf    # 207}\ “ì“Œ‚Ì‹÷’Œ‚ª”ò‚Ô" at 15,6.7
...
#set title "{ {\sf H}}{\bf “ ‰×d`•ÏˆÊŠÖŒWi\–Êbj}"
...
#set title "{ {\sf H}}{\bf “ ‰×d`•ÏˆÊŠÖŒWi\–Êaj}"
...
#set title "{ {\sf H}}{\bf “ ‰×d`‘wŠÔ•ÏˆÊŠÖŒWi\–Êbj}"
...
#set title "{ {\sf H}}{\bf “ ‰×d`‘wŠÔ•ÏˆÊŠÖŒWi\–Êaj}"
